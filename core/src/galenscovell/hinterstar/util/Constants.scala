...
object Constants {
  ...
  // Map dimensions
  val MAP_WIDTH: Int = 35
  val MAP_HEIGHT: Int = 19
  val SYSTEMMARKER_SIZE: Int = 20
  val SYSTEM_MARKER_X: Int = SYSTEMMARKER_SIZE
  val SYSTEM_MARKER_Y: Int = -SYSTEMMARKER_SIZE * 5
  val SYSTEM_MARKER_CENTER_X: Int = SYSTEMMARKER_SIZE * 3
  val SYSTEM_MARKER_CENTER_Y: Int = (-SYSTEMMARKER_SIZE * 3) - (SYSTEMMARKER_SIZE / 2)
